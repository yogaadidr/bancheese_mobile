...
abstract class RequestMenu(val context : Context, private val idCabang: String){

    fun execute(){
        val url = context.getString(R.string.web_api_url).toString()+"vmenu/"+idCabang
        ...
        AndroidNetworking.get(url)
            ...
            .getAsJSONObject(object : JSONObjectRequestListener {
                override fun onResponse(response: JSONObject?) {
                    this@RequestMenu.onResponse(response!!)
                }
                override fun onError(anError: ANError?) {
                    this@RequestMenu.onError(anError!!)
                }
            })
